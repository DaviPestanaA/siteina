...
export default function SocialMediaClients() {
  ...
  const socialClients = clients?.filter((c) => c.type === "social_media") || [];
  ...
  const handleCreateClient = () => {
    ...
    createClient.mutate({ name: newClientName, type: "social_media" });
  };
  ...
  return (
    <div className="min-h-screen bg-background">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-muted-foreground">
                Gerencie seus clientes de Social Media
              </p>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {socialClients.map((client) => (
            <Card
              ...
              onClick={() => setLocation(`/clients/social/${client.id}`)}
            >
              <CardHeader>
          ...
          {socialClients.length === 0 && (
            <div className="col-span-full text-center py-12">
              <p className="text-muted-foreground">
                Nenhum cliente de Social Media cadastrado ainda.
              </p>
              <Button
      ...
      <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>Novo Cliente de Social Media</DialogTitle>
          </DialogHeader>
